...
# Verify the SafeMode administrator password by asking the user to re-enter it
$adminPasswordVerify = Read-Host -Prompt 'Please re-enter the SafeMode administrator password' -AsSecureString

# Compare both entered passwords
if (-not (Compare-Object $adminPassword $adminPasswordVerify)) {
